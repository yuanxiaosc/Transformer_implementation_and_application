...
if __name__ == "__main__":
    ...
    print(f"look_ahead_mask shape:\t{combined_mask.shape}")
    print(f"dec_padding_mask shape:\t{dec_padding_mask.shape}")
    transformer_output, attention_weights = transformer(temp_input, temp_target, training=True,
                                                        enc_padding_mask=enc_padding_mask,
                                                        look_ahead_mask=combined_mask,
                                                        dec_padding_mask=dec_padding_mask)
    # tf.keras.utils.plot_model(transformer, show_shapes=True, to_file='transformer_model_A.png')
    print("---------------transformer---------------")
    print(f"transformer_output.shape:\t{transformer_output.shape}")  # (batch_size, tar_seq_len, target_vocab_size)
